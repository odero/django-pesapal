...
if settings.configured:
    ...
    if PESAPAL_DEMO:
        ...
        PESAPAL_QUERY_STATUS_LINK = getattr(settings, 'PESAPAL_QUERY_STATUS_LINK', 'https://www.pesapal.com/API/QueryPaymentStatus')
    ...
    PESAPAL_ITEM_DESCRIPTION = getattr(settings, 'PESAPAL_ITEM_DESCRIPTION', False)

    PESAPAL_TRANSACTION_MODEL = getattr(settings, 'PESAPAL_TRANSACTION_MODEL', '')