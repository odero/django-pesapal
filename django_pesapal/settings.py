...
if PESAPAL_DEMO:
    ...
    PESAPAL_IFRAME_LINK = getattr(settings, 'PESAPAL_IFRAME_LINK', 'http://pesapal.com/api/PostPesapalDirectOrderV4')
...
PESAPAL_OAUTH_CALLBACK_URL = getattr(settings, 'PESAPAL_OAUTH_CALLBACK_URL', '')
